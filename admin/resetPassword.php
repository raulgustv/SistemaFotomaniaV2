...
if(!isset($tokenenviado)){
    ...
    redir("./"); 
        ...
        if(mysqli_num_rows($qcr)<=0){
            redir("http://localhost/SISTEMAFOTOMANIAv2/admin/loginAdmin.php");
        }else{
	...
	<div class="row">
			<div class="col-lg-4 offset-lg-4 bg-light rounded" id="resetpass-box">
				...
				<form action="" method="post" role="form" class="p-2" id="resetpass-frm">
					...
					<div class="form-group">
						<input type="submit" id="restconAD" name="restconAD" value="Restablecer" class="btn btn-success btn-block">
                    </div>
                    <div class="form-group">
